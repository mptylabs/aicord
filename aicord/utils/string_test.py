...
def test_split_paragraph_chunks():
    test_cases = [
        ...
        (
            "This is a long paragraph that needs to be split into multiple chunks because it exceeds the maximum length.",
            20,
            [
                "This is a long",
        ...
        (
            "This is a single paragraph that exceeds the maximum length.",
            10,
            [
                "This is a",
                "single",
